...
class _CustomTextFormFieldState extends State<CustomTextFormField> {
  ...
  void initState() {
    ...
    underline = {
      ...
      BorderType.focused: AppColors.focusUnderLineBorder.copyWith(
          borderSide: AppColors.focusUnderLineBorder.borderSide
              .copyWith(color: widget.borderFocusedColor)),
      BorderType.error: AppColors.errorUnderLineBorder.copyWith(
          borderSide: AppColors.errorUnderLineBorder.borderSide
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //     hintStyle: widget.hintStyle ??
          //         TextStyle(
          //             color: AppColors.fourthMainColor.withOpacity(.8),
